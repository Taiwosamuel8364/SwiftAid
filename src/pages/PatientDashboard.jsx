...
const OUT_TOPIC = "esp32/lab/sensors/data";
      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-xl border border-white p-6 mb-6">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            <div>
              <h1 className="text-4xl font-bold text-slate-800">🚑 SwiftAid</h1>
            ...
            <div className="mt-4 md:mt-0 flex items-center gap-3">
              <div
                className={`w-4 h-4 rounded-full animate-pulse ${
                  status.includes("Connected") ? "bg-green-500" : "bg-red-500"
                }`}
              />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-6 border-l-4 border-red-500 hover:scale-105 transition duration-300">
            <p className="text-gray-500 text-sm mb-2">Heart Rate</p>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-6 border-l-4 border-blue-500 hover:scale-105 transition duration-300">
            <p className="text-gray-500 text-sm mb-2">Oxygen Saturation</p>

            <h2 className="text-5xl font-bold text-blue-500">{vitals.spo2}</h2>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-6 border-l-4 border-green-500 hover:scale-105 transition duration-300">
            <p className="text-gray-500 text-sm mb-2">Stability</p>
          ...
          >
            <p className="text-gray-500 text-sm mb-2">Fall Detection</p>

            <h2
              className={`text-2xl font-bold ${
                vitals.fall ? "text-red-600 animate-pulse" : "text-emerald-600"
              }`}
            >
        ...
        <div className="mt-6 bg-white rounded-3xl shadow-xl p-6 border-l-4 border-purple-500">
          ...
          {location ? (
            ...
            <p className="text-gray-500">Getting GPS location...</p>
          )}
        </div>
